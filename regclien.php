...
if(!$nitCliente=="" && !$nameCliente=="" && !$fullnameCliente=="" && !$apeCliente=="" && !$passCliente=="" && !$dirCliente=="" && !$phoneCliente=="" && !$emailCliente=="" ){
    $verificar=  ejecutarSQL::consultar("select * from cliente where NIT= '".$nitClient."'");
