        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>Nuestra Tienda <small class="tittles-pages-logo">"Bordadora"</small></h1>
                </div>
                <!--consulta para mirar los productos que estan registrador en el apartado de productos-->
                <?php 
