...
if($num>0){
  ...
  for($i = 0;$i< $_SESSION['contador'];$i++){
    ...
    echo '<img src="assets/img/ok.png" class="center-all-contens"><br>Tus productos han sido guardados y listos para realizar tu compra.. Da click en el siguiente botón para poder continuar..';
  }else{
