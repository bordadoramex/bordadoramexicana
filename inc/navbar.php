...
<nav id="navbar-auto-hidden"> <!--Menu  -->
        <div class="row hidden-xs">

            <div class="col-xs-4" >
                
                <img src="assets/img/logco-1.png" alt="" width="185" border="2" HSPACE="5"  VSPACE="7" height="90" align="left" >
                <br><br>
                <h5><i>Bordamos tu belleza, tejemos tu imagen...</i></h5>

                
            </div>
            <div class="col-xs-8">
                <h3 align="left"><b>Bordadora Mexicana S.A de C.V </b>  </h3>
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en Bordadora Mexicana</h4>
                </div>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Bordadra Mexicana</h3>
        ...
        <ul class="list-unstyled text-center">
            ...
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
                    echo '<li><a href="configAdmi.php">Administración</a></li>';
