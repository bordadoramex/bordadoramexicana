        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo"></small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <center>
                    <video width="520" height="400" align ="left" autoplay muted loop controls>
                      <source src="assets/img-products/20190508_142835.mp4" type="video/mp4" > 
                    </video>
                  </center>
                </div>
                <div class="col-xs-12 col-sm-6">
                   <br><br>
                    <div id="container-form" >
                       ...
                       <br><br>
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save" whidth="540" height="450" align="right">
                           <div class="form-group">
                              <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-credit-card"></i></div>
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de NIT" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su número de NIT. Solamente números y guiones(-)" maxlength="30" pattern="[0-9-]{14,30}" class="form-control">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="email" placeholder="Ingrese su Email" required name="clien-email" data-toggle="tooltip" data-placement="top" title="Ingrese su dirección Email" maxlength="50">
                              </div>
                            </div>
                            <br>
