    ...
    <section id="prove-product-cat-config">
        <div class="container">
            ...
            <!-- Nav tabs -->
              ...
              <li role="presentation"><a href="#almac" role="tab" data-toggle="tab">Categorias</a></li>
            ...
            <div class="tab-content">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" name="prod-categoria">
                                   <!--==========================consulta para agregar una categoria===================-->
                                    <?php 
                             ...
                             <form action="process/delprod.php" method="post" role="form">
                                 <div class="form-group">
                                     ...
                                     <select class="form-control" name="prod-code">
                                         <!--==========================consulta para agregar un producto===================-->
                                         <?php 
                ...
                <!--==============================Panel Proveedores===============================-->
                <div role="tabpanel" class="tab-pane in active" id="Proveedores">
                    <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <br><br>
                        <div id="add-provee">
                            ...
                            <form action="process/delprove.php" method="post" role="form">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nit-prove">
                                        <!--==========================consulta para seleccionar un proveedor===================-->
                                        <?php 
                        ...
                        <div class="panel panel-info">
                          ...
                          <div class="table-responsive">
                              <table class="table table-borderless table-dark">
                                  ...
                                  <tbody>
                                      <!--==========================consulta para actualizar un proveedor===================-->
                                      <?php
                ...
                <!--==============================Panel Almacenes===============================-->
                <div role="tabpanel" class="tab-pane fade in active" id="almac">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <br><br>
                            <div id="add-categori">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-dark">
                                        ...
                                        <tbody>
                                            <!--==========================consulta para actualizar una categoria===================-->
                                            <?php
                             ...
                             <div class="panel panel-info">
                              ...
                              <div class="table-responsive">
                                  <table class="table table-borderless table-dark">
                                      ...
                                      <tbody>
                                          <!--==========================consulta para actualizar una venta===================-->
                                          <?php
           ...
           <div role="tabpanel" class="tab-pane in active" id="clientes">
                <div class="rows">
                            
                        <div class="col-xs-12">
                            <br><br>
                            <div class="panel panel-info">
                                <div class="panel-heading text-center"><i class="fa fa-users fa-5x"></i><h3>Clientes Registrados</h3></div>
                                <div class="table-responsive">
                                    <table class="table table-borderless table-dark">
                                        <thead class="">
                                            <tr>
                                        ...
                                        <tbody>
                                            <!--==========================consulta para mirar los clientes registrados===================-->
                                            <?php
                                              $cliente=  ejecutarSQL::consultar("select * from cliente");
                                              $ui=1;
                                              while($clien=mysqli_fetch_array($cliente)){
                                                  echo '
                                                      <div id="update-category">
                                                        <form method="post" action="process/updateCategory.php" id="res-update-category-'.$ui.'">
                                                          <tr>
                                                              <td>
                                                                ...
                                                                <input class="form-control"  disabled="disabled" type="text" name="categ-code" maxlength="9" required="" value="'.$clien['NIT'].'">
                                                              </td>
                                                              <td><input class="form-control" disabled="disabled" type="text" name="categ-name" maxlength="30" required="" value="'.$clien['NombreCompleto'].'"></td>
                                                              <td><input class="form-control" disabled="disabled" type="text-area" name="categ-descrip" required="" value="'.$clien['Apellido'].'"></td>
                                                              <td><input class="form-control" disabled="disabled" type="text" name="categ-name" maxlength="30" required="" value="'.$clien['Direccion'].'"></td>
                                                              <td><input class="form-control" readonly="readonly" type="text" name="categ-name" maxlength="30" required="" value="'.$clien['Telefono'].'"></td>
                                                              <td><input class="form-control" disabled="disabled" type="text" name="categ-name" maxlength="30" required="" value="'.$clien['Email'].'"></td>
                                                              <td class="text-center">
